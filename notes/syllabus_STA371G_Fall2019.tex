...
\vskip.18in
\noindent\textbf{\large  Teaching Assistant:} 	
...
\noindent \textbf{Note using any homework and exam solutions that are not distributed by the instructor is considered as a strong violation of Academic Honesty and will be penalized with significant grade reduction if found. %Any dishonest behaviors during the exams will lead to zero grade.
}
...
\begin{itemize}
\item The midterm Exam  will be on Monday, October 21 (GEA 105, 6:45-9:45 pm). 
%\vspace{-2.5mm}
